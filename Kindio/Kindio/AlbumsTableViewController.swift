...
class AlbumsTableViewController: MediaItemTableViewController {
    ...
    override var query: MPMediaQuery! {
        didSet {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.assetTitleLabel.text = mediaItem.representativeItem?.albumTitle
        ...
        cell.assetImageView.image = UIImage.init(imageLiteral: "musicRecord")
